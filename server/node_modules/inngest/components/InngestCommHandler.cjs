			...
			if (method === "POST" || forceExecution) {
				...
				if (forceExecution) {
					...
					if (dieHeader) {
						...
						else this.log("warn", `Received invalid value for ${require_consts.headerKeys.InngestForceStepPlan} header: ${dieHeader}. Expected a boolean value. Defaulting to "false".`);
					}
					body = {
						event: {},
						events: [],
